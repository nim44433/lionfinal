            ...
            <div className='w-full flex justify-center flex-col px-4'>
                ...
                <div id="refer" className="w-full h-screen pt-5 scroller space-y-4 overflow-y-auto pb-[240px]">
                    ...
                    <div className='w-full flex justify-between bg-[#17181A] rounded-[12px] relative z-10'>
                        <div onClick={() => handleMenu(1)} className={`${activeIndex === 1 ? 'bg-btn text-[#ebebeb]' : ''} rounded-[6px] text-[#c6c6c6] py-[10px] text-nowrap barTitle px-3 w-[100%] flex space-x-2 justify-center text-center text-[14px] font-semibold items-center`}>
                            <span>All time</span>
                        </div>
                    </div>
                ...
                <div ref={infoRefTwo} className={`${
                    ...
                    <div className="w-full flex justify-center flex-col items-center space-y-3">
                        ...
                        <p className="pb-6 text-[13px] w-full text-center">
                            ...
                            <br />The top 10 users get special bonus and benefits on listing and launching day! Boost your rank or Keep performing activities to increase your earnings!
                        </p>
                    </div>
