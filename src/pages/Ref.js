...
const Ref = () => {
  ...
  const copyToClipboard = () => {
    ...
    const reflink = `https://t.me/AlphaGhost_Bot?start=r${id}\n\$LOT tokens mining is live! Two is better than one!  Join my squad, and let\'s double the fun (and earnings 🤑)! $LOT Power Tap! 🚀`;
  ...
  const handleShare = async () => {
    const shareData = {
      ...
      text: "$LOT tokens mining is live! Two is better than one!  Join my squad, and let's double the fun (and earnings 🤑)! $LOT Power Tap! 🚀",
    };
          ...
          <div className="w-full pt-3 justify-center flex-col space-y-3 px-5">
            <div className="w-full flex justify-center">
              <h1 className="font-semibold text-[28px] text-[#ffffffe0] pb-1 text-center">
                Invite friends <br/>& get more $LOT
              </h1>
            </div>
...
<div className="flex items-center space-x-3">
  <img src='/stars2.svg' alt="gf" className="w-[60px]"/>
