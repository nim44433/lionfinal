            ...
            <div id="refer" className="w-full h-screen pt-5 scroller space-y-3 overflow-y-auto pb-[180px]">
              ...
              <div className={`w-full overflow-hidden space-y-3 ${loadingTwo ? 'hidden' : 'block'}`}>
                <div className='w-full h-[60px] overflow-hidden rounded-[12px] bg-btn flex items-center justify-center text-center font-semibold relative'>
                  ...
                  <img src='/scorebg.svg' alt='ifd' className='object-cover object-center w-[400px] h-[220px] absolute left-[0px] mt-[-10px] right-0' />
                </div>

                <div className='w-full flex justify-center bg-[#000000] rounded-[12px] relative overflow-hidden'>
                  <div className='w-full relative flex flex-col px-0 pt-0 items-center'>
                    <img src='stars.svg' alt='stars' className='w-[900px]' />
                    <h4 className='font-semibold text-[32px] pt-2'>
                      {formatNumber(balance)}
                    </h4>
                    <p className='pb-6'>$LOT</p>
