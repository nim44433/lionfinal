...
<div className='w-full flex flex-col pt-2 space-y-3 justify-center items-center relative'>
...
<img src='/medal2.svg' alt='ffdv' className='absolute mt-[-90px] w-[24px]'/>
                    ...
                    <div className='flex flex-col w-[100%] items-center justify-center !mb-[-60px]'>
