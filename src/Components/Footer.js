  ...
  const footerLinks = [
    {
      title: "Home",
      link: "/",
      icon: <img id="reels2" alt="dfd" src="/home.svg" className={location.pathname === "/" ? "w-[25px] h-[25px] brightness-[0.1]" : "w-[22px] h-[22px]"} />
    },
    {
      title: "Friends",
      link: "/ref",
      icon: <img alt="dfd" src="/ref.svg" className={location.pathname === "/ref" ? "w-[25px] h-[25px] brightness-[0.1]" : "w-[22px] h-[22px]"} />
    },
    {
      title: "Leaders",
      link: "/leaderboard",
      icon: <img alt="dfd" src="/leaders.svg" className={location.pathname === "/leaderboard" ? "w-[25px] h-[25px] brightness-[0.1]" : "w-[22px] h-[22px]"} />
    }
  ];
