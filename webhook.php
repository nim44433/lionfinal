...
if ($text === '/start') {
    ...
    $caption = "
    👋 **Welcome to the LIONS (LOT) Adventure!** 🐾🎮

    Get ready for a tail-wagging journey where every paw-tap leads to bigger rewards! Here’s what’s waiting for you:

    ✨ **Play LIONS(LOT)**: Tap the dog bone and watch your balance fetch amazing rewards!
    ...
    🔗 **Connect with Us:**
    - Developed by [@Blockchain_AI_DEVELOPER](https://t.me/Blockchain_AI_DEVELOPER)
    - Join our [Lions Lovers Telegram Pack](https://t.me/Blockchain_AI_DEVELOPER) for the latest updates and tail-wagging fun!

    🐾 **Get Started Now** and take your dog on the ultimate GamaDog adventure!

    👉 [Join Community](https://t.me/Blockchain_AI_DEVELOPER)
    ";
        ...
        'reply_markup' => json_encode([
            'inline_keyboard' => [
                [
                    ...
                    ['text' => 'Join Our Community', 'url' => 'https://t.me/Blockchain_AI_DEVELOPER']]
            ]
        ])
    ];
